...
<head>
    ...
    <meta name="description" content="<?php echo $tpl["descripcion"] ?>">
    <meta name="viewport" content="width=device-width, initial-scale=1">
                    ...
                    <div class="row">
                        <div class="col-md-3 clearfix mb-sm-50">
                            <div class="fooler-col f1">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?=$_n?>directorio.html" class="thm-btn hvr-3 bg1 cw btn-nv text-center" target="_blank">
                                            Directorio
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?=$_n?>descargas/privacidadagrogen.pdf" target="_blank" class="thm-btn hvr-3 bg1 cw btn-nv text-center">
                                            Aviso de privacidad
                                        </a>
                                    </li>
                                </ul>
